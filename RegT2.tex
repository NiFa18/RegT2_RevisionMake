...
\IfFileExists{./revision.tex} %if
{\include{revision}\newcommand{\versioninfo}{\revisiondate, $Commit: \revision$ - gem\"ass Unterricht Markus Kottmann/FS2013}} %then
{\newcommand{\versioninfo}{keine git Info verfügbar - gem\"ass Unterricht Markus Kottmann/FS2013}} %else
